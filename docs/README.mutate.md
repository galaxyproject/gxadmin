...
[`mutate drop-workflow-step-output-associations2`](#mutate-drop-workflow-step-output-associations2) | #8418, drop extraneous connection, v2 for large sites
[`mutate drop-workflow-step-output-associations`](#mutate-drop-workflow-step-output-associations) | #8418, drop extraneous connection
...
mutate drop-workflow-step-output-associations2 -  #8418, drop extraneous connection, v2 for large sites
...
mutate drop-workflow-step-output-associations -  #8418, drop extraneous connection
