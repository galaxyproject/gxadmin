...
query_workflow-trace-archive-workflow-invocation-steps() { ## : [Workflow Trace Archive] Export workflow invocation steps
	handle_help "$@" <<-EOF
		Helper for WTA
	EOF
...
query_workflow-trace-archive-workflow-connections() { ## : [Workflow Trace Archive] Export workflow connections
	handle_help "$@" <<-EOF
		Helper for WTA
	EOF
